        ...
        <div class="col-lg-12 m-3">
            ...
            <div class="card border-success">
                <h4 class="card-header bg-success d-flex justify-content-between">
                    <span class="text-light align-self-center">Test Category</span>
...
{{--                                            @if(checkUserRole('test.destroy'))--}}
                                                <form id="delete-form-{{ $loop->index }}"
                                                      action="{{ route('test.category.destroy', $item->id) }}"
                                                      method="post"
...
@push('customScripts')
    <script>
        ...
        function showData(item) {
            ...
            $("select[name*='lab_id']").val(item.lab_id);
        ...
        $('#editForm').on('submit', function (e) {
            ...
            $.ajax({
                ...
                error: function (xhr, status, error) {
                    ...
                    if (errors.errors.hasOwnProperty("lab_id")) {
                        $("#update_lab_id_error").text(errors.errors.lab_id[0]);
                    }
                },
            })
        })
