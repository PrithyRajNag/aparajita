        ...
        <div class="col-lg-12 m-3">
            <div class="card border-success">
                ...
                <div class="card-body f-13">
                    <div class="row">
                        <form role="form" class="clearfix" action="{{route('test.patient.store')}}" method="POST"
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="row pb-2">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input type="number" name="age" min="0" id="age" class="form-control"
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="row pb-2">
                                    ...
                                    <input type="text" id="referred_doctor_id" name="referred_doctor_id" hidden>

                                    <div class="form-group col-sm-6">
                                        <label class="font-weight-bold">Name:</label>
                                        <input type="text" name="doctor_name" id="doctor_name" class="form-control"
                                               placeholder="Name" value="{{ old('doctor_name') }}">
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" name="institution_name" id="institution_name"
                                               class="form-control" value="{{ old('institution_name') }}"
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" name="doctor_contact_number" id="doctor_contact_number"
                                               class="form-control"
                                               placeholder="Contact" value="{{ old('doctor_contact_number') }}">
                                        @if ($errors->has('doctor_contact_number'))
                                            <span class="text-danger">{{ $errors->first('doctor_contact_number') }}</span>
                                        @endif
                                    </div>
                                    <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="card-body f-13">
                                    <div class="table-responsive" id="">
                                        ...
                                        <!-- <input type="text" id="test_room" name="test_room[]" hidden>
                                        <input type="text" id="test_floor" name="test_floor[]" hidden> -->
                            ...
                            <div class="form-group mt-3 col-sm-4 offset-sm-4">
                                <input type="submit" name="submit" value="Submit" id="createBtn"
...
@push('customScripts')
    <script>
        ...
        $("input[name*='room']").keyup(function () {
            let value_input = $("input[name*='room']").val();
            let regexp = /[^0-9]/g;
            if (value_input.match(regexp)) {
                $("input[name*='room']").val(value_input.replace(regexp, ''))
            }
        });
        var testResult;
        var result;
        ...
        $('#createTestBtn').click(function (data) {
            ...
            if(title_array.indexOf(title) !== -1)
            {
                ...
                // $("#test_room").val(room_array);
                // $("#test_floor").val(floor_array);
                ...
                // var room = row.insertCell(2);
                // var floor = row.insertCell(3);
        ...
        function deleteRow(item) {
            ...
            room_array.splice(rowIndex - 1, 1);
            floor_array.splice(rowIndex - 1, 1);
            ...
            for (var index = 0; index< table.rows.length; index++){
                table.rows[index].cells[0].innerHTML = sl; sl++;
            }
