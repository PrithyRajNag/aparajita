    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h4 class="modal-title text-light">Add Accounts</h4>
            ...
            <div class="modal-body row">
                <form role="form" action="" class="clearfix" method="post" enctype="multipart/form-data" style="width: 100%; display: contents;">
                    ...
                    <div class="form-group mt-3 col-sm-4 offset-sm-4">
                        <input type="submit" name="addAccountsBtn" id="addAccountsBtn" value="Submit" class="btn btn-success btn-block btn-lg">
                    </div>
                </form>
            </div>
        </div>
