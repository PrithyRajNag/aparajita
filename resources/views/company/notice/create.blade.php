<div class="modal fade" id="addNot">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h4 class="modal-title text-light">Noties Board</h4>
            ...
            <div class="modal-body row">
                <form role="form" action="" class="clearfix" method="post" style="width: 100%; display: contents;">
                    ...
                    <div class="form-group mt-5 col-md-4 offset-md-4">
                        <input type="submit" name="addNotBtn" id="" value="Add Not" class="btn btn-success btn-block btn-lg">
                    </div>
                </form>
            </div>
        </div>
