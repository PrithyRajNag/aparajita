...
<div class="container">
    ...
    <div class="row justify-content-center wrapper" id="login-box">
        <div class="col-6 my-auto ">
            <div><h1 class="text-center text-light pb-3">Tajul Islam Diagnostic</h1></div>
...
{{--                            </div>--}}
                ...
                {{--                    <p class="text-center font-weight-bolder text-light lead">Enter your personal details and start your--}}
                {{--                        journey with us!</p>--}}
                {{--                    <button class="btn btn-outline-light btn-lg align-self-center font-weight-bolder mt-4 myLinkBtn"--}}
                {{--                            id="password-link">Forgot Password--}}
                {{--                    </button>--}}
                {{--                </div>--}}
            </div>
        </div>
    ...
    <div class="row justify-content-center wrapper" id="forgot-box" style="display: none;">
        ...
        <div class="col-6 my-auto ">
            ...
            <div class="row myShadow">
                <div class="bg-white p-4" style="width: 100%">
                    <button class="btn btn-sm" id="back-link" style="font-size: 25px"><i class="fas fa-arrow-circle-left"></i>
                    </button>
                    <h2 class="text-center font-weight-bold text-primary">Forgot Your Password?</h2>
                    <hr class="my-3"/>
                    <p class="lead text-center text-secondary">To reset your password, enter the registered e-mail
                        address and we will send you password reset instructions on your e-mail!</p>
                    <form action="{{ route('forget.password.post') }}" method="post" class="px-3" id="forgot-form">
                        ...
                        <div class="input-group input-group-lg form-group">
                            ...
                            {{--                            <input type="email" id="female" name="email" class="form-control rounded-0" placeholder="E-Mail" required />--}}
                        ...
                        <div class="form-group">
                            <button type="submit" id="forgot-btn" class="btn btn-primary btn-lg btn-block myBtn">Reset
                                Password
                            </button>
                        </div>
                    </form>
